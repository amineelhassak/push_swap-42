...
SRCS = ./src/algo/big_sort.c ./src/algo/indexing.c ./src/algo/is_sort.c ./src/algo/max_index.c ./src/algo/mid_sort.c \
		...
		./src/allocation/free.c ./src/instra/push.c ./src/instra/rev_rotate.c  main.c\
...
SRCS_B = ./get_next_linee/get_next_line_utils.c ./get_next_linee/get_next_line.c ./cheker/checker.c ./cheker/main.c \
...
OBJS = $(SRCS:.c=.o)
OBJS_B = $(SRCS_B:.c=.o)
BATHHEADERS = includes/headers.h includes/stractus.h cheker/checker.h get_next_linee/get_next_line.h
RM = @rm -f
...
$(NAME): $(OBJS)
	$(MAKELIB)
	$(CC) -o $(NAME) $(OBJS) $(PATHLIB_A)

bonus:color $(OBJS_B)
	$(MAKELIB)
	$(CC) -o $(CHECK) $(OBJS_B) $(PATHLIB_A)
